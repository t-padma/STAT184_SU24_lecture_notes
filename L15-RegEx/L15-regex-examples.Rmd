...
UniqueNames%>% 
  filter(grepl(pattern = "shine",     # character containing RegEx
               x = name,              # character vector to be matched to 
               ignore.case = TRUE))   # matching is not case-sensitive
```
